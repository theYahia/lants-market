/*privy-bundle*/
import{a as m,b as c,c as r,d,e as M,f as s}from"./chunk-6FI3YGPV.js";import{i as n}from"./chunk-33MCIVAL.js";n();var f=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,p,i)=>{for(var e=i>1?void 0:i?y(l,p):l,h=a.length-1,g;h>=0;h--)(g=a[h])&&(e=(i?g(l,p,e):g(e))||e);return i&&e&&f(l,p,e),e},t=class extends d{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([M("ph-magnifying-glass")],t);export{t as PhMagnifyingGlass};
