/*privy-bundle*/
import{a as m,b as n,c as r,d as g,e as c,f as s}from"./chunk-6FI3YGPV.js";import{i as V}from"./chunk-33MCIVAL.js";V();var d=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,a=(o,i,H,p)=>{for(var e=p>1?void 0:p?Z(i,H):i,h=o.length-1,l;h>=0;h--)(l=o[h])&&(e=(p?l(i,H,e):l(e))||e);return p&&e&&d(i,H,e),e},t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return n`<svg
  ...
  `;a([s({type:String,reflect:!0})],t.prototype,"size",2);a([s({type:String,reflect:!0})],t.prototype,"weight",2);a([s({type:String,reflect:!0})],t.prototype,"color",2);a([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=a([c("ph-browser")],t);export{t as PhBrowser};
