/*privy-bundle*/
import{a as c,b as g,c as r,d as Z,e as d,f as o}from"./chunk-6FI3YGPV.js";import{i as n}from"./chunk-33MCIVAL.js";n();var A=Object.defineProperty,f=Object.getOwnPropertyDescriptor,s=(a,i,h,p)=>{for(var e=p>1?void 0:p?f(i,h):i,l=a.length-1,m;l>=0;l--)(m=a[l])&&(e=(p?m(i,h,e):m(e))||e);return p&&e&&A(i,h,e),e},t=class extends Z{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;s([o({type:String,reflect:!0})],t.prototype,"size",2);s([o({type:String,reflect:!0})],t.prototype,"weight",2);s([o({type:String,reflect:!0})],t.prototype,"color",2);s([o({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([d("ph-clock")],t);export{t as PhClock};
