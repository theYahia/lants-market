/*privy-bundle*/
import{a as g,b as Z,c as r,d as c,e as A,f as o}from"./chunk-6FI3YGPV.js";import{i as n}from"./chunk-33MCIVAL.js";n();var d=Object.defineProperty,f=Object.getOwnPropertyDescriptor,i=(a,s,m,p)=>{for(var e=p>1?void 0:p?f(s,m):s,l=a.length-1,h;l>=0;l--)(h=a[l])&&(e=(p?h(s,m,e):h(e))||e);return p&&e&&d(s,m,e),e},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return Z`<svg
  ...
  `;i([o({type:String,reflect:!0})],t.prototype,"size",2);i([o({type:String,reflect:!0})],t.prototype,"weight",2);i([o({type:String,reflect:!0})],t.prototype,"color",2);i([o({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=i([A("ph-warning-circle")],t);export{t as PhWarningCircle};
